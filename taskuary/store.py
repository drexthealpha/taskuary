...
DEFAULT_ROLES = {'outlook': 'trigger,tool', 'teams': 'trigger,tool', 'slack': 'trigger,tool',
                 ...
                 'finnhub': 'report,tool', 'polygon': 'report,tool', 'tiingo': 'report,tool', 'fmp': 'report,tool',
    ...
    def __init__(self, path):
        ...
        with self.lock:
            ...
            for t, n in (('outlook', 'Outlook mail'), ('teams', 'Microsoft Teams'),
                         ...
                         ('finnhub', 'Finnhub'), ('polygon', 'Polygon.io'), ('tiingo', 'Tiingo'), ('fmp', 'Financial Modeling Prep'),
